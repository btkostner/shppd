defmodule Shppd.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      # Start a worker by calling: Shppd.Worker.start_link(arg)
      # {Shppd.Worker, arg},
    ...
    opts = [strategy: :one_for_one, name: Shppd.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ShppdWeb.Endpoint.config_change(changed, removed)
    :ok
  end
